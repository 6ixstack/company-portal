  ...
  footer.innerHTML = `
    <div class="container">
      ...
      <div class="footer-bottom text-center">
        <p class="copyright text-white">© ${new Date().getFullYear()} 6ixStack Solutions. All rights reserved. | <a href="privacy-policy.html" class="text-white text-decoration-none">Privacy Policy</a></p>
      </div>
    </div>
