      ...
      <div class="row">
        <div class="col-lg-4 footer-widget">
          ...
          <div class="footer-social">
            <a href="https://www.linkedin.com/company/6ixstack-solutions/#" target="_blank"><i class="fab fa-linkedin-in"></i></a>
            <a href="https://www.instagram.com/6ixstack_solutions/#" target="_blank"><i class="fab fa-instagram"></i></a>
          </div>
        </div>
